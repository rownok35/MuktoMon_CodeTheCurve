  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    private void sendMessage() {
                        ...
                        if (!this.initialRequest) {
                            ...
                            if((inputMessage.getMessage().length()==2)||(inputMessage.getMessage().equals("male"))||(inputMessage.getMessage().equals("female"))||inputMessage.getMessage().equals("lonely")
                            ||inputMessage.getMessage().equals("lonely")||inputMessage.getMessage().equals("tensed")||inputMessage.getMessage().equals("stress")||inputMessage.getMessage().equals("depression")){
                                data.append(inputMessage.getMessage()+",");
                                str=data.toString();
                            }
                            if(inputMessage.getMessage().equals("back"))
                            {
                                def= FirebaseDatabase.getInstance().getReference().child("user");
                                def.push().setValue(str);
                            }
                        } else {
                            Message inputMessage = new Message();
                            inputMessage.setMessage(inputmessage);
